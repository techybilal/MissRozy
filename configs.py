...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','main-virallinkswale.koyeb.app') else APP_NAME+'.herokuapp.com'
...
class Config(object):
	API_ID = int(os.environ.get("API_ID", "1310494"))
	API_HASH = os.environ.get("API_HASH", "b5a1655d116c74826af2aae9a82af74f")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6144687436:AAGShuVn551CQHCWjRkdoBIteGgV0SUWxBo")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "ViralLinkswaleBot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002145302942"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "626424377"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://bill2002gates:7208723700@Bilal@cluster0.wkgsrwg.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002119835381")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001999856727")
